...
6. (Optional) In the **Realism** card pick **Random** and dial the five per-effect sliders — **film grain**, **radial chromatic aberration**, **vignette**, **color jitter**, and **JPEG artifacts**. Each runs independently on every captured PNG to narrow the sim-to-real gap. Bounding boxes are preserved.
