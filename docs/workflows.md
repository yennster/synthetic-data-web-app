...
6. (Optional) In the **Realism** card pick **Random** and set an intensity — every PNG is run through a per-capture film-grain / chromatic-aberration / vignette / color-jitter pass to narrow the sim-to-real gap. Bounding boxes are preserved.
